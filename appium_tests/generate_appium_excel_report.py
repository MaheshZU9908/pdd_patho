# generate_appium_excel_report.py
# Generate comprehensive Excel report for Appium test cases
...
class AppiumExcelReportGenerator:
    def __init__(self, output_path="appium_tests/Appium_Test_Report.xlsx"):
        self.output_path = output_path
        self.workbook = openpyxl.Workbook()
        self.sheet = self.workbook.active
        self.sheet.title = "Appium Tests"
    ...
    def add_test_data(self):
        """Add test data rows"""
        for row_num, test_case in enumerate(TEST_CASES_APPIUM, 2):
    ...
    def apply_conditional_formatting(self):
        ...
        for row_num in range(2, len(TEST_CASES_APPIUM) + 2):
    ...
    def add_summary_sheet(self):
        ...
        # Title
        summary_sheet['A1'] = "APPIUM TEST EXECUTION SUMMARY"
        ...
        summary_sheet['B13'] = len(TEST_CASES_APPIUM)
        
        summary_sheet['A14'] = "Application:"
        summary_sheet['B14'] = "PathoAI Mobile (Android)"
        
        summary_sheet['A15'] = "Test Type:"
        summary_sheet['B15'] = "Appium Automation Testing"
    ...
    def generate_report(self):
        ...
        print(f"✓ Appium test report generated: {self.output_path}")
